...
import com.dg.security.jwt.AuthEntryPointJwt;
import com.dg.security.jwt.AuthTokenFilter;
import com.dg.security.service.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		List<String> antPatternStrings = new ArrayList<>();
		antPatternStrings.addAll(Arrays.asList("/api/login", "/api/signup", "/api/refreshtoken", "/api/test/**", "/api/status"));
		// Deprecated AngularJS frontend
		antPatternStrings.addAll(Arrays.asList("/", "/webjars/**", "/js/**", "/vehicle-list/**", "/vehicle-detail/**"));
